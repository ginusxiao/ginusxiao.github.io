...
Status BuildTable(
  ...
  IOStatus io_s;
  meta->fd.file_size = 0;
  # iter的类型是MergingIterator，它是由多个MemTable的Iterator构成的最小堆，堆顶的元素总是
  # 所有MemTable对应的Iterator中具有最小value的那个
  #
  # SeekToFirst会找到所有MemTable中最小的那个value
  iter->SeekToFirst();
  ...
  # range_del_iter的类型是FragmentedRangeTombstoneIterator，这里将所有MemTable对应的
  # FragmentedRangeTombstoneIterator添加到CompactionRangeDelAggregator中
